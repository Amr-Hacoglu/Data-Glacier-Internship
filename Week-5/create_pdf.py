...
def take_screenshots():
    ...
    screenshots = [
        ...
        ("heroku_deployment.png", "Switch to your Heroku deployment terminal"),
        ("heroku_app.png", "Switch to your deployed Heroku app in the browser")
    ]
...
def create_pdf():
    ...
    c.drawString(50, height - 50, "Model Deployment Steps (Cloud and API)")
    ...
    screenshots = [
        ...
        ("Step 4: Deploying to Heroku", "heroku_deployment.png"),
        ("Step 5: Deployed Heroku App", "heroku_app.png")
    ]
